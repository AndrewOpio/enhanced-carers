        ...
        <table class="table table-striped" border = "0">
            ...
            ?>
                ...
                <tr>
                  ...
                  <td class = "action">
                      <button type = "button" class = "button" data-toggle = "modal" data-target = "#<?php echo $service->Id."update"; ?>" data-backdrop = "true">Update</button>
                  </td>

                  <td class = "action">
                      <button type = "button" class = "button" data-toggle = "modal" data-target = "#<?php echo $service->Id."delete"; ?>" data-backdrop = "true">Delete</button>
                  </td>
                </tr>
