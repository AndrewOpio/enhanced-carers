      ...
      <form method="POST" id = "add">
        <div class="input">
          <div class="form-group col-md-12">
            ...
            <input type="email" class="form-control" id="email" name = "email" placeholder = "agency email..">
          </div>
        ...
        <table id = "table" class="table table-striped" border = "0">
            ...
            ?>
                ...
                <tr>
                  ...
                  <td class = "text"><b><?php echo $shift->Email?></b></td>
                  ...
                  <td class = "action">
                      <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                 <button type = "button" style = "border-width : 1px; border-color: #e2e2e2;" class = "btn" data-toggle = "modal" data-target = "#<?php echo $shift->Id."close"; ?>" data-backdrop = "true">Close</button>
                                 <button type = "button" style = "border-width : 1px; border-color: #e2e2e2;" class = "btn" data-toggle = "modal" data-target = "#<?php echo $shift->Id."update"; ?>" data-backdrop = "true">Update</button>
                                 <button type = "button" style = "border-width : 1px; border-color: #e2e2e2;" class = "btn" data-toggle = "modal" data-target = "#<?php echo $shift->Id."delete"; ?>" data-backdrop = "true">Delete</button>
                            </div>
                      </div>
                    </td>                  
                </tr>
